...
const Agricultural = () => {
  return (
    ...
    <div className='mt-16 mb-8'>
      ...
      <img src="https://images.pexels.com/photos/5998120/pexels-photo-5998120.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="agricultural_image" className='shadow-lg object-cover transition transform scale-100 hover:scale-110' />
      </div>
      <div className=""><h1 className='text-3xl text-center mt-6   capitalize font-base font-bold '>Our Ready to move sites</h1></div>
