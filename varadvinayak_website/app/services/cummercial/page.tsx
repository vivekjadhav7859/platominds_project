...
const Cummercial = () => {
  return (
    ...
    <div className='mt-16 mb-8'>
      ...
      <img src="https://images.pexels.com/photos/18821289/pexels-photo-18821289/free-photo-of-building-with-apartments.jpeg" alt="agricultural_image" className='shadow-lg object-cover transition transform scale-100 hover:scale-110' />
      </div>
      <div className=""><h1 className='text-3xl text-center mt-6   capitalize font-base font-bold '>Our Fasclilating Cummercial Sites</h1></div>
